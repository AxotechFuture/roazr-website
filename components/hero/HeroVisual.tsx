...
const FEED = [
  ...
  { amount: "₦124,000", label: "Paystack payment", target: "Snapchat", dot: "#17e88f" },
...
/* The three systems the mock shows connected, all shipping today: conversions
   out to Meta and Snapchat, payments in from Paystack. Google Ads and TikTok
...
export function PlatformChip({ p }: { p: PlatformChipData }) {
  return (
    <div className="flex items-center gap-2.5 rounded-xl border border-line-strong bg-raised/95 px-3 py-2.5 shadow-[0_24px_64px_-24px_rgba(0,0,0,0.9)] backdrop-blur-xl">
      ...
      <span className="ml-auto shrink-0 font-mono text-[10px] text-accent">✓</span>
    </div>
  );
}
