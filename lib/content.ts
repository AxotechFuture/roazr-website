...
export const faqs = [
  {
    ...
    a: "Roazr is a full revenue attribution platform. It matches every sale you close (on your website, by card or bank transfer, on a booked call, or in a WhatsApp chat) back to the exact ad that brought the customer in, then sends those real purchase events to Meta and Snapchat server-side. Their algorithms learn who actually buys from you and optimize toward more of them. Google Ads, TikTok, and Pinterest sync are on the roadmap.",
  },
  {
  ...
  {
    q: "What does the AI WhatsApp agent do?",
    a: "It's an assistant for you, not a bot that messages your customers. Link your WhatsApp number, then ask things like 'how did my ads do this week?' or 'which creatives are winning?', log a sale by text, or move leads through your pipeline from chat. Every change waits for your one-tap confirm, and you can undo it within 15 minutes.",
  },
  {
  ...
  },
  {
    ...
    a: "One plan with every feature: ₦19,000 a month for Nigerian businesses, or $19 a month everywhere else. That is down from a $99 list price while the founding window is open, and it stays locked for life if you subscribe before it closes. Annual is ₦200,000 / $200. Start with a 14-day free trial; we only ask for a card when you decide to stay. Full breakdown on the pricing page.",
  },
] as const;
...
export const features = [
  ...
  },
  {
    ...
    body: "Purchases reach Meta and Snapchat server-side, with the original click ID attached. No browser pixel in the path means nothing for ad blockers to eat.",
    key: "capi",
  },
  {
  ...
  {
    title: "Your ad account, on WhatsApp",
    body: "Chat with Roazr like a teammate. Ask how your ads did this week, log a sale by text, move leads through your pipeline. Every change waits for your one-tap confirm.",
    key: "agent",
  },
  {
...
export const steps = [
  ...
  },
  {
    ...
    body: "Real purchase events flow back to Meta and Snapchat the moment they happen. Their algorithms learn who actually buys, and go find you more of them.",
  },
] as const;
